...
import fr.milekat.societe.api.SocieteMileKatAPI;
import fr.milekat.societe.commands.MoneyCmd;
import fr.milekat.societe.listeners.DefaultTags;
import fr.milekat.societe.storage.Storage;
...
public class Main extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        //  Load API
        SocieteMileKatAPI.LOADED_API = new API();
        SocieteMileKatAPI.API_READY = true;
        //  Load plugin workers
